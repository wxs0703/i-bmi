...
from ML_BMI_Permute_Feature_Importance import permutation_importance 
...
def permute_model(model, dataset, device, output_dir):
    df_importance = permutation_importance(
        model,
        dataset,              
        device,
        batch_size=64,
    ...
    print("\nPermutation importance (sorted, most important first):")
    print(df_importance[["feature_index", "feature_name", "delta_accuracy"]].head(20))

    importance_path = os.path.join(output_dir, "permutation_importance.csv")
    df_importance.to_csv(importance_path, index=False)
    print(f"\nSaved permutation importance to: {importance_path}")
...
if __name__ == "__main__":
    DATA_DIR = "/Users/saulcastillo/Desktop/ML_Project_BMI"
    MODEL_DIR = "/Users/saulcastillo/Desktop/ML_Project_BMI"
    OUTPUT_DIR = "/Users/saulcastillo/Desktop/ML_Project_BMI/outputs"
    ...
    #permute_model(model, dataset, DEVICE, OUTPUT_DIR)
